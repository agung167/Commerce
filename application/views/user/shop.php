...
<head>
    ...
    <!-- Title  -->
    <title>Amado - Furniture Ecommerce | Shop</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="<?php echo base_url('cart') ?>" class="cart-nav"><img src="assetsA/img/core-img/cart.png" alt=""> Cart <span>(<?php
                  $this->db->from('cart');
                  $this->db->where('_c', '1');
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                      <?php foreach ($this->s_model->findAll() as $kategori) { ?>
        ...
        <div class="amado_product_area section-padding-100">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php foreach ($all_featured_products as $data) { ?>
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <a href="<?php echo base_url('U_product/single/' . $data->id_produk); ?>"><img src="<?php echo base_url(); ?>/upload/<?php echo $data->gambar; ?>" style="width: 460px; height: 350px;" alt="" ></a>
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="<?php echo base_url('U_product/single/' . $data->id_produk); ?>">
