...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="<?php echo base_url(); ?>assetsA/img/core-img/asd.png">
                ...
                <div class="col-12">
                    <div class="search-content">
                        <form action="#" method="get">
                            ...
                            <button type="submit"><img src="<?php echo base_url(); ?>assetsA/img/core-img/search.png" alt=""></button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="<?php echo base_url('Shop'); ?>">Shop</a></li>
            ...
            <div class="cart-fav-search mb-100">
                <a href="<?php echo base_url('login') ?>" class="cart-nav"><img src="<?php echo base_url(); ?>assetsA/img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                            <img class="d-block w-100" src="<?php echo base_url('upload/'.$data->gambar)?>" alt="" style="width: 723px; height: 550px">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <form class="cart clearfix" method="post">
                                ...
                                <a href="<?php echo base_url('Login') ?>" class="btn amado-btn">Add to Cart</a>
                            </form>
